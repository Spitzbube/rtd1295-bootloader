...
// Firmware Header Generate Date : 2013/7/24 15:26:5
***************************************************************/
...
{
unsigned int     reserved_0:23;
unsigned int     fix_l:1;
unsigned int     fix_h:1;
...
#define VO_DACT_fix_l_shift                                                          (8)
#define VO_DACT_fix_l_mask                                                           (0x00000100)
#define VO_DACT_fix_l(data)                                                          (0x00000100&((data)<<8))
#define VO_DACT_fix_l_src(data)                                                      ((0x00000100&(data))>>8)
#define VO_DACT_get_fix_l(data)                                                      ((0x00000100&(data))>>8)
#define VO_DACT_fix_h_shift                                                          (7)
#define VO_DACT_fix_h_mask                                                           (0x00000080)
#define VO_DACT_fix_h(data)                                                          (0x00000080&((data)<<7))
#define VO_DACT_fix_h_src(data)                                                      ((0x00000080&(data))>>7)
#define VO_DACT_get_fix_h(data)                                                      ((0x00000080&(data))>>7)
