...
#define UMSK_ISR_reg_addr                                                            "0x1801B008"
#define UMSK_ISR_reg                                                                 0x1801B008
...
#define UMSK_ISR_RTC_HSEC_INT_shift                                                  (9)
#define UMSK_ISR_RTC_HSEC_INT_mask                                                   (0x00000200)
#define UMSK_ISR_RTC_HSEC_INT(data)                                                  (0x00000200&((data)<<9))
#define UMSK_ISR_RTC_HSEC_INT_src(data)                                              ((0x00000200&(data))>>9)
#define UMSK_ISR_get_RTC_HSEC_INT(data)                                              ((0x00000200&(data))>>9)
...
#define ISR_reg_addr                                                                 "0x1801B00C"
#define ISR_reg                                                                      0x1801B00C
...
#define ISR_RTC_HSEC_INT_shift                                                       (9)
#define ISR_RTC_HSEC_INT_mask                                                        (0x00000200)
#define ISR_RTC_HSEC_INT(data)                                                       (0x00000200&((data)<<9))
#define ISR_RTC_HSEC_INT_src(data)                                                   ((0x00000200&(data))>>9)
...
#define ISR_WDOG_NMI_INT_shift                                                       (2)
#define ISR_WDOG_NMI_INT_mask                                                        (0x00000004)
#define ISR_WDOG_NMI_INT(data)                                                       (0x00000004&((data)<<2))
#define ISR_WDOG_NMI_INT_src(data)                                                   ((0x00000004&(data))>>2)
#define ISR_get_WDOG_NMI_INT(data)                                                   ((0x00000004&(data))>>2)
...
#define DBG_reg_addr                                                                 "0x1801B02C"
#define DBG_reg                                                                      0x1801B02C
...
#define DUMMY_reg_addr                                                               "0x1801B030"
#define DUMMY_reg                                                                    0x1801B030
...
#define DUMMY_Rvd2_shift                                                             (8)
#define DUMMY_Rvd2_mask                                                              (0x00007F00)
#define DUMMY_Rvd2(data)                                                             (0x00007F00&((data)<<8))
#define DUMMY_Rvd2_src(data)                                                         ((0x00007F00&(data))>>8)
#define DUMMY_get_Rvd2(data)                                                         ((0x00007F00&(data))>>8)
...
#define DUMMY_Rvd1_shift                                                             (0)
#define DUMMY_Rvd1_mask                                                              (0x0000007F)
#define DUMMY_Rvd1(data)                                                             (0x0000007F&((data)<<0))
#define DUMMY_Rvd1_src(data)                                                         ((0x0000007F&(data))>>0)
#define DUMMY_get_Rvd1(data)                                                         ((0x0000007F&(data))>>0)
...
#define DUMMY1                                                                       0x1801B068
#define DUMMY1_reg_addr                                                              "0x1801B068"
#define DUMMY1_reg                                                                   0x1801B068
#define set_DUMMY1_reg(data)   (*((volatile unsigned int*) DUMMY1_reg)=data)
#define get_DUMMY1_reg   (*((volatile unsigned int*) DUMMY1_reg))
#define DUMMY1_inst_adr                                                              "0x001A"
#define DUMMY1_inst                                                                  0x001A
...
#define SCPU_INT_EN_reg_addr                                                         "0x1801B080"
#define SCPU_INT_EN_reg                                                              0x1801B080
...
#define GPDEB                                                                        0x1801B150
#define GPDEB_reg_addr                                                               "0x1801B150"
#define GPDEB_reg                                                                    0x1801B150
#define set_GPDEB_reg(data)   (*((volatile unsigned int*) GPDEB_reg)=data)
#define get_GPDEB_reg   (*((volatile unsigned int*) GPDEB_reg))
#define GPDEB_inst_adr                                                               "0x0054"
#define GPDEB_inst                                                                   0x0054
