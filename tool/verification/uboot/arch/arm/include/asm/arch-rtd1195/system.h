...
#define MIPS_VIDEO_FLAG_PTR_V1_ADDR		(ARM_ROMCODE_SIZE+0x000000d4)
#define MIPS_VIDEO_FLAG_PTR_V2_ADDR		(ARM_ROMCODE_SIZE+0x000000d8)
#define MIPS_VIDEO_FW_ENTRY_PTR_V2_ADDR		(ARM_ROMCODE_SIZE+0x000000dc)
#define MIPS_AUDIO_FW_ENTRY_PTR_ADDR		(ARM_ROMCODE_SIZE+0x000000e0)
#define MIPS_VIDEO_FW_ENTRY_PTR_V1_ADDR		(ARM_ROMCODE_SIZE+0x000000e4)
#define MIPS_SHARED_PRINTK_BUFFER_ADDR		(ARM_ROMCODE_SIZE+0x000000e8)	// 0x000000e8~0x000000ff
...
#define MIPS_AUDIO_OUTPUT_INFO_ADDR		(ARM_ROMCODE_SIZE+0x00001000)
...
#define UBOOT_EXTERN_PARAM_ADDR			(ARM_ROMCODE_SIZE+0x00002800)	//bootcode parater in paddr, kernel will read boot_param at this address
//#define UBOOT_LOGO_START_ADDR			(0x00003000)
//#define ECPU_KERNEL_ENTRY_ADDR		(0x00004000)
#define EXTERN_PARAM_FROM_FLASH_ADDR		(ARM_ROMCODE_SIZE+0x00009000)	// 0x00011000~0x000117ff
...
// RTD1195 Dummy Register
// for phoenix, refer to romcode sysdefs.h, iso doc
...
//#define VCPU_JUMP_ADDR_reg					/* register which represent VCPU jump address */
