...
#define DBG                                                                          0x1801A024
#define DBG_reg_addr                                                                 "0xB801A024"
#define DBG_reg                                                                      0xB801A024
...
#define DBG_Dbg_mode_shift                                                           (0)
#define DBG_Dbg_mode_mask                                                            (0x0000001F)
#define DBG_Dbg_mode(data)                                                           (0x0000001F&((data)<<0))
#define DBG_Dbg_mode_src(data)                                                       ((0x0000001F&(data))>>0)
#define DBG_get_Dbg_mode(data)                                                       ((0x0000001F&(data))>>0)


#define DEBUG                                                                        0x1801A028
#define DEBUG_reg_addr                                                               "0xB801A028"
#define DEBUG_reg                                                                    0xB801A028
#define set_DEBUG_reg(data)   (*((volatile unsigned int*) DEBUG_reg)=data)
#define get_DEBUG_reg   (*((volatile unsigned int*) DEBUG_reg))
#define DEBUG_inst_adr                                                               "0x000A"
#define DEBUG_inst                                                                   0x000A
#define DEBUG_write_enable3_shift                                                    (15)
#define DEBUG_write_enable3_mask                                                     (0x00008000)
#define DEBUG_write_enable3(data)                                                    (0x00008000&((data)<<15))
#define DEBUG_write_enable3_src(data)                                                ((0x00008000&(data))>>15)
#define DEBUG_get_write_enable3(data)                                                ((0x00008000&(data))>>15)
#define DEBUG_sel1_shift                                                             (9)
#define DEBUG_sel1_mask                                                              (0x00007E00)
#define DEBUG_sel1(data)                                                             (0x00007E00&((data)<<9))
#define DEBUG_sel1_src(data)                                                         ((0x00007E00&(data))>>9)
#define DEBUG_get_sel1(data)                                                         ((0x00007E00&(data))>>9)
#define DEBUG_write_enable2_shift                                                    (8)
#define DEBUG_write_enable2_mask                                                     (0x00000100)
#define DEBUG_write_enable2(data)                                                    (0x00000100&((data)<<8))
#define DEBUG_write_enable2_src(data)                                                ((0x00000100&(data))>>8)
#define DEBUG_get_write_enable2(data)                                                ((0x00000100&(data))>>8)
#define DEBUG_sel0_shift                                                             (2)
#define DEBUG_sel0_mask                                                              (0x000000FC)
#define DEBUG_sel0(data)                                                             (0x000000FC&((data)<<2))
#define DEBUG_sel0_src(data)                                                         ((0x000000FC&(data))>>2)
#define DEBUG_get_sel0(data)                                                         ((0x000000FC&(data))>>2)
#define DEBUG_write_enable1_shift                                                    (1)
#define DEBUG_write_enable1_mask                                                     (0x00000002)
#define DEBUG_write_enable1(data)                                                    (0x00000002&((data)<<1))
#define DEBUG_write_enable1_src(data)                                                ((0x00000002&(data))>>1)
#define DEBUG_get_write_enable1(data)                                                ((0x00000002&(data))>>1)
#define DEBUG_enable_shift                                                           (0)
#define DEBUG_enable_mask                                                            (0x00000001)
#define DEBUG_enable(data)                                                           (0x00000001&((data)<<0))
#define DEBUG_enable_src(data)                                                       ((0x00000001&(data))>>0)
#define DEBUG_get_enable(data)                                                       ((0x00000001&(data))>>0)
