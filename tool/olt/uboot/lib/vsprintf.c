...
static int vsn//printf_internal(char *buf, size_t size, const char *fmt,
			      va_list args)
{
...
#ifdef CONFIG_SYS_VSN//printf
int vsn//printf(char *buf, size_t size, const char *fmt,
			      va_list args)
{
	return vsn//printf_internal(buf, size, fmt, args);
}

int vscn//printf(char *buf, size_t size, const char *fmt, va_list args)
{
	int i;

	i = vsn//printf(buf, size, fmt, args);
...
int sn//printf(char *buf, size_t size, const char *fmt, ...)
{
	va_list args;
	int i;
...
int scn//printf(char *buf, size_t size, const char *fmt, ...)
{
	va_list args;
	int i;

	va_start(args, fmt);
	i = vscn//printf(buf, size, fmt, args);
	va_end(args);
 ...
 * into @buf. Use vsn//printf() or vscn//printf() in order to avoid
 * buffer overflows.
 *
...
{
	return vsn//printf_internal(buf, INT_MAX, fmt, args);
}
