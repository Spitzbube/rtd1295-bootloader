...
enum opt_code
{
  ...
  OPT_ffilelist_file = 607,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 608,               /* -ffinite-math-only */
  OPT_ffix_bdsl = 609,                       /* -ffix-bdsl */
  OPT_ffixed_ = 610,                         /* -ffixed- */
  OPT_ffixed_form = 611,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 612,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 613,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 614,                    /* -ffloat-store */
  OPT_ffor_scope = 615,                      /* -ffor-scope */
  /* OPT_fforce_addr = 616, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 617,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 618,              /* -fforward-propagate */
  OPT_ffp_contract_ = 619,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 620,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 621,                      /* -ffpe-trap= */
  OPT_ffree_form = 622,                      /* -ffree-form */
  OPT_ffree_line_length_ = 623,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 624,          /* -ffree-line-length-none */
  OPT_ffreestanding = 625,                   /* -ffreestanding */
  OPT_ffriend_injection = 626,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 627,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 628,                   /* -ffunction-cse */
  OPT_ffunction_sections = 629,              /* -ffunction-sections */
  OPT_fgcse = 630,                           /* -fgcse */
  OPT_fgcse_after_reload = 631,              /* -fgcse-after-reload */
  OPT_fgcse_las = 632,                       /* -fgcse-las */
  OPT_fgcse_lm = 633,                        /* -fgcse-lm */
  OPT_fgcse_sm = 634,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 635,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 636,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 637,                         /* -fgnu-tm */
  OPT_fgnu_unique = 638,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 639,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 640,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 641,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 642,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 643,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 644,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 645,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 646,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 647,                       /* -fgraphite */
  OPT_fgraphite_identity = 648,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 649,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 650, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 651, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 652,           /* -fhash-synchronization */
  /* OPT_fhelp = 653, */                     /* -fhelp */
  /* OPT_fhelp_ = 654, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 655,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 656, */                /* -fhonor-std */
  OPT_fhosted = 657,                         /* -fhosted */
  /* OPT_fhuge_objects = 658, */             /* -fhuge-objects */
  OPT_fident = 659,                          /* -fident */
  OPT_fif_conversion = 660,                  /* -fif-conversion */
  OPT_fif_conversion2 = 661,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 662,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 663,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 664,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 665,             /* -fimplicit-templates */
  OPT_findirect_classes = 666,               /* -findirect-classes */
  OPT_findirect_dispatch = 667,              /* -findirect-dispatch */
  OPT_findirect_inlining = 668,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 669,         /* -finhibit-size-directive */
  OPT_finit_character_ = 670,                /* -finit-character= */
  OPT_finit_integer_ = 671,                  /* -finit-integer= */
  OPT_finit_local_zero = 672,                /* -finit-local-zero */
  OPT_finit_logical_ = 673,                  /* -finit-logical= */
  OPT_finit_real_ = 674,                     /* -finit-real= */
  OPT_finline = 675,                         /* -finline */
  OPT_finline_atomics = 676,                 /* -finline-atomics */
  OPT_finline_functions = 677,               /* -finline-functions */
  OPT_finline_functions_called_once = 678,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 679, */            /* -finline-limit- */
  OPT_finline_limit_ = 680,                  /* -finline-limit= */
  OPT_finline_small_functions = 681,         /* -finline-small-functions */
  OPT_finput_charset_ = 682,                 /* -finput-charset= */
  OPT_finstrument_functions = 683,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 684,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 685,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 686,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 687,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 688,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 689,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 690,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 691, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 692,                    /* -fipa-profile */
  OPT_fipa_pta = 693,                        /* -fipa-pta */
  OPT_fipa_pure_const = 694,                 /* -fipa-pure-const */
  OPT_fipa_reference = 695,                  /* -fipa-reference */
  OPT_fipa_sra = 696,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 697, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 698,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 699,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 700,              /* -fira-loop-pressure */
  OPT_fira_region_ = 701,                    /* -fira-region= */
  OPT_fira_share_save_slots = 702,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 703,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 704,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 705,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 706,/* -fisolate-erroneous-paths-dereference */
  ...
  OPT_flax_vector_conversions = 714,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 715,             /* -fleading-underscore */
  OPT_flifetime_dse = 716,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 717,           /* -flive-range-shrinkage */
  OPT_floop_block = 718,                     /* -floop-block */
  /* OPT_floop_flatten = 719, */             /* -floop-flatten */
  OPT_floop_interchange = 720,               /* -floop-interchange */
  OPT_floop_nest_optimize = 721,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 722, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 723,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 724,                /* -floop-strip-mine */
  OPT_flto = 725,                            /* -flto */
  OPT_flto_compression_level_ = 726,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 727,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 728,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 729,              /* -flto-partition=max */
  OPT_flto_partition_none = 730,             /* -flto-partition=none */
  OPT_flto_report = 731,                     /* -flto-report */
  OPT_flto_report_wpa = 732,                 /* -flto-report-wpa */
  OPT_flto_ = 733,                           /* -flto= */
  OPT_fltrans = 734,                         /* -fltrans */
  OPT_fltrans_output_list_ = 735,            /* -fltrans-output-list= */
  OPT_fmain_ = 736,                          /* -fmain= */
  OPT_fmath_errno = 737,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 738,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 739,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 740,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 741,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 742,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 743,                     /* -fmem-report */
  OPT_fmem_report_wpa = 744,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 745,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 746,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 747,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 748,                /* -fmessage-length= */
  OPT_fmodule_private = 749,                 /* -fmodule-private */
  OPT_fmodulo_sched = 750,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 751,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 752,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 753,                  /* -fms-extensions */
  /* OPT_fmudflap = 754, */                  /* -fmudflap */
  /* OPT_fmudflapir = 755, */                /* -fmudflapir */
  /* OPT_fmudflapth = 756, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 757, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 758, */                  /* -fnew-abi */
  OPT_fnext_runtime = 759,                   /* -fnext-runtime */
  OPT_fnil_receivers = 760,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 761, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 762,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 763,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 764, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 765,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 766,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 767,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 768,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 769,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 770,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 771,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 772,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 773,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 774,             /* -fomit-frame-pointer */
  OPT_fopenmp = 775,                         /* -fopenmp */
  OPT_fopenmp_simd = 776,                    /* -fopenmp-simd */
  OPT_foperator_names = 777,                 /* -foperator-names */
  OPT_fopt_info = 778,                       /* -fopt-info */
  OPT_fopt_info_ = 779,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 780, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 781,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 782,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 783,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 784, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 785,              /* -foutput-class-dir= */
  OPT_fpack_derived = 786,                   /* -fpack-derived */
  OPT_fpack_struct = 787,                    /* -fpack-struct */
  OPT_fpack_struct_ = 788,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 789,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 790,              /* -fpcc-struct-return */
  OPT_fpch_deps = 791,                       /* -fpch-deps */
  OPT_fpch_preprocess = 792,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 793,                     /* -fpeel-loops */
  OPT_fpeephole = 794,                       /* -fpeephole */
  OPT_fpeephole2 = 795,                      /* -fpeephole2 */
  OPT_fpermissive = 796,                     /* -fpermissive */
  OPT_fpic = 797,                            /* -fpic */
  OPT_fpie = 798,                            /* -fpie */
  OPT_fplan9_extensions = 799,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 800,                    /* -fplugin-arg- */
  OPT_fplugin_ = 801,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 802,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 803,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 804,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 805,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 806,                   /* -fpreprocessed */
  OPT_fpretty_templates = 807,               /* -fpretty-templates */
  OPT_fprofile = 808,                        /* -fprofile */
  OPT_fprofile_arcs = 809,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 810,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 811,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 812,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 813,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 814,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 815,                 /* -fprofile-report */
  OPT_fprofile_use = 816,                    /* -fprofile-use */
  OPT_fprofile_use_ = 817,                   /* -fprofile-use= */
  OPT_fprofile_values = 818,                 /* -fprofile-values */
  OPT_fprotect_parens = 819,                 /* -fprotect-parens */
  OPT_frandom_seed = 820,                    /* -frandom-seed */
  OPT_frandom_seed_ = 821,                   /* -frandom-seed= */
  OPT_frange_check = 822,                    /* -frange-check */
  OPT_freal_4_real_10 = 823,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 824,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 825,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 826,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 827,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 828,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 829,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 830,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 831,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 832,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 833,                /* -frecord-marker=8 */
  OPT_frecursive = 834,                      /* -frecursive */
  OPT_freduced_reflection = 835,             /* -freduced-reflection */
  OPT_free = 836,                            /* -free */
  OPT_freg_struct_return = 837,              /* -freg-struct-return */
  /* OPT_fregmove = 838, */                  /* -fregmove */
  OPT_frename_registers = 839,               /* -frename-registers */
  OPT_freorder_blocks = 840,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 841,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 842,              /* -freorder-functions */
  OPT_frepack_arrays = 843,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 844,           /* -freplace-objc-classes */
  OPT_frepo = 845,                           /* -frepo */
  OPT_frequire_return_statement = 846,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 847,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 848, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 849,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 850,                    /* -fresolution= */
  OPT_frlxcov = 851,                         /* -frlxcov */
  OPT_frounding_math = 852,                  /* -frounding-math */
  OPT_frtti = 853,                           /* -frtti */
  OPT_fsanitize_ = 854,                      /* -fsanitize= */
  OPT_fsaw_java_file = 855,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 856,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 857,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 858,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 859,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 860,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 861,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 862,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 863,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 864,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 865,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 866,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 867,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 868,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 869,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 870,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 871,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 872,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 873, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 874,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 875,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 876,              /* -fsecond-underscore */
  OPT_fsection_anchors = 877,                /* -fsection-anchors */
  /* OPT_fsee = 878, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 879,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 880,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 881, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 882,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 883,          /* -fselective-scheduling2 */
  OPT_fshort_double = 884,                   /* -fshort-double */
  OPT_fshort_enums = 885,                    /* -fshort-enums */
  OPT_fshort_wchar = 886,                    /* -fshort-wchar */
  OPT_fshow_column = 887,                    /* -fshow-column */
  OPT_fshrink_wrap = 888,                    /* -fshrink-wrap */
  OPT_fsign_zero = 889,                      /* -fsign-zero */
  OPT_fsignaling_nans = 890,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 891,               /* -fsigned-bitfields */
  OPT_fsigned_char = 892,                    /* -fsigned-char */
  OPT_fsigned_zeros = 893,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 894,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 895,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 896,               /* -fsource-filename= */
  OPT_fsource_ = 897,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 898,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 899,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 900,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 901, */                 /* -fsquangle */
  OPT_fstack_arrays = 902,                   /* -fstack-arrays */
  /* OPT_fstack_check = 903, */              /* -fstack-check */
  OPT_fstack_check_ = 904,                   /* -fstack-check= */
  OPT_fstack_limit = 905,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 906,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 907,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 908,                /* -fstack-protector */
  OPT_fstack_protector_all = 909,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 910,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 911,                   /* -fstack-reuse= */
  OPT_fstack_usage = 912,                    /* -fstack-usage */
  OPT_fstats = 913,                          /* -fstats */
  OPT_fstore_check = 914,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 915, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 916,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 917,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 918,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 919, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 920,      /* -fstrict-volatile-bitfields */
  OPT_fsuppress_outer_loop_unroll = 921,     /* -fsuppress-outer-loop-unroll */
  OPT_fsync_libcalls = 922,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 923,                    /* -fsyntax-only */
  OPT_ftabstop_ = 924,                       /* -ftabstop= */
  /* OPT_ftarget_help = 925, */              /* -ftarget-help */
  OPT_ftarget_ = 926,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 927,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 928, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 929,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 930,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 931, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 932,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 933,             /* -fthreadsafe-statics */
  OPT_ftime_report = 934,                    /* -ftime-report */
  OPT_ftls_model_ = 935,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 936,               /* -ftoplevel-reorder */
  OPT_ftracer = 937,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 938,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 939,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 940,                  /* -ftrapping-math */
  OPT_ftrapv = 941,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 942,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 943,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 944,                       /* -ftree-ccp */
  OPT_ftree_ch = 945,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 946,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 947,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 948,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 949,                /* -ftree-copyrename */
  OPT_ftree_cselim = 950,                    /* -ftree-cselim */
  OPT_ftree_dce = 951,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 952,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 953,                       /* -ftree-dse */
  OPT_ftree_forwprop = 954,                  /* -ftree-forwprop */
  OPT_ftree_fre = 955,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 956,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 957,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 958,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 959,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 960,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 961,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 962, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 963,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 964,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 965,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 966,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 967,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 968,                   /* -ftree-phiprop */
  OPT_ftree_pre = 969,                       /* -ftree-pre */
  OPT_ftree_pta = 970,                       /* -ftree-pta */
  OPT_ftree_reassoc = 971,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 972, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 973,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 974,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 975,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 976,                      /* -ftree-slsr */
  OPT_ftree_sra = 977,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 978, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 979, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 980,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 981,                /* -ftree-tail-merge */
  OPT_ftree_ter = 982,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 983, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 984,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 985, */ /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 986,                       /* -ftree-vrp */
  OPT_ftword = 987,                          /* -ftword */
  OPT_ftword_stack = 988,                    /* -ftword-stack */
  OPT_funderscoring = 989,                   /* -funderscoring */
  OPT_funit_at_a_time = 990,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 991,               /* -funroll-all-loops */
  OPT_funroll_loops = 992,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 993,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 994,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 995,             /* -funsigned-bitfields */
  OPT_funsigned_char = 996,                  /* -funsigned-char */
  OPT_funswitch_loops = 997,                 /* -funswitch-loops */
  OPT_funwind_tables = 998,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 999,            /* -fuse-atomic-builtins */
  OPT_fuse_balx = 1000,                      /* -fuse-balx */
  OPT_fuse_boehm_gc = 1001,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1002,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1003,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1004,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1005,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1006,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1007,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1008,                       /* -fuse-tls */
  OPT_fuse_uls = 1009,                       /* -fuse-uls */
  OPT_fvar_tracking = 1010,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1011,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1012,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1013,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1014,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1015, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1016,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1017,                   /* -fverbose-asm */
  /* OPT_fversion = 1018, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1019,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1020,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1021,                   /* -fvisibility= */
  OPT_fvpt = 1022,                           /* -fvpt */
  /* OPT_fvtable_gc = 1023, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1024, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1025,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1026,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1027,                     /* -fvtv-debug */
  OPT_fweak = 1028,                          /* -fweak */
  OPT_fweb = 1029,                           /* -fweb */
  /* OPT_fwhole_file = 1030, */              /* -fwhole-file */
  OPT_fwhole_program = 1031,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1032,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1033,             /* -fworking-directory */
  OPT_fwpa = 1034,                           /* -fwpa */
  OPT_fwpa_ = 1035,                          /* -fwpa= */
  OPT_fwrapv = 1036,                         /* -fwrapv */
  /* OPT_fxref = 1037, */                    /* -fxref */
  /* OPT_fzee = 1038, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1039,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1040,                     /* -fzero-link */
  OPT_g = 1041,                              /* -g */
  OPT_gant = 1042,                           /* -gant */
  OPT_gcoff = 1043,                          /* -gcoff */
  OPT_gdwarf = 1044,                         /* -gdwarf */
  OPT_gdwarf_ = 1045,                        /* -gdwarf- */
  OPT_gen_decls = 1046,                      /* -gen-decls */
  OPT_ggdb = 1047,                           /* -ggdb */
  OPT_ggnu_pubnames = 1048,                  /* -ggnu-pubnames */
  OPT_gnat = 1049,                           /* -gnat */
  OPT_gnatO = 1050,                          /* -gnatO */
  OPT_gno_pubnames = 1051,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1052,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1053,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1054,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1055,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1056,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1057,                   /* -gsplit-dwarf */
  OPT_gstabs = 1058,                         /* -gstabs */
  OPT_gstabs_ = 1059,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1060,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1061,                        /* -gtoggle */
  OPT_gvms = 1062,                           /* -gvms */
  OPT_gxcoff = 1063,                         /* -gxcoff */
  OPT_gxcoff_ = 1064,                        /* -gxcoff+ */
  OPT_h = 1065,                              /* -h */
  OPT_idirafter = 1066,                      /* -idirafter */
  OPT_imacros = 1067,                        /* -imacros */
  OPT_imultiarch = 1068,                     /* -imultiarch */
  OPT_imultilib = 1069,                      /* -imultilib */
  OPT_include = 1070,                        /* -include */
  OPT_iplugindir_ = 1071,                    /* -iplugindir= */
  OPT_iprefix = 1072,                        /* -iprefix */
  OPT_iquote = 1073,                         /* -iquote */
  OPT_isysroot = 1074,                       /* -isysroot */
  OPT_isystem = 1075,                        /* -isystem */
  OPT_iwithprefix = 1076,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1077,              /* -iwithprefixbefore */
  OPT_k8 = 1078,                             /* -k8 */
  OPT_l = 1079,                              /* -l */
  OPT_lang_asm = 1080,                       /* -lang-asm */
  OPT_mabi_ = 1081,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1082,             /* -mabort-on-noreturn */
  OPT_mandroid = 1083,                       /* -mandroid */
  OPT_mapcs = 1084,                          /* -mapcs */
  OPT_mapcs_float = 1085,                    /* -mapcs-float */
  OPT_mapcs_frame = 1086,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1087,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1088,              /* -mapcs-stack-check */
  OPT_march_ = 1089,                         /* -march= */
  OPT_marm = 1090,                           /* -marm */
  OPT_mbig_endian = 1091,                    /* -mbig-endian */
  OPT_mbionic = 1092,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1093,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1094,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1095,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1096,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1097,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1098,                  /* -mfp16-format= */
  OPT_mfpu_ = 1099,                          /* -mfpu= */
  OPT_mglibc = 1100,                         /* -mglibc */
  /* OPT_mhard_float = 1101, */              /* -mhard-float */
  OPT_mlittle_endian = 1102,                 /* -mlittle-endian */
  OPT_mlong_calls = 1103,                    /* -mlong-calls */
  OPT_mlra = 1104,                           /* -mlra */
  OPT_mmusl = 1105,                          /* -mmusl */
  OPT_mneon_for_64bits = 1106,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1107,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1108,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1109,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1110,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1111,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1112,                   /* -mrestrict-it */
  OPT_msched_prolog = 1113,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1114,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1115,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1116, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1117,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1118,                         /* -mthumb */
  OPT_mthumb_interwork = 1119,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1120,                  /* -mtls-dialect= */
  OPT_mtp_ = 1121,                           /* -mtp= */
  OPT_mtpcs_frame = 1122,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1123,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1124,                         /* -mtune= */
  OPT_muclibc = 1125,                        /* -muclibc */
  OPT_munaligned_access = 1126,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1127,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1128,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1129,              /* -mword-relocations */
  OPT_mwords_little_endian = 1130,           /* -mwords-little-endian */
  OPT_n = 1131,                              /* -n */
  ...
  OPT_profile = 1160,                        /* -profile */
  OPT_pthread = 1161,                        /* -pthread */
  OPT_quiet = 1162,                          /* -quiet */
  OPT_r = 1163,                              /* -r */
  OPT_rdynamic = 1164,                       /* -rdynamic */
  OPT_remap = 1165,                          /* -remap */
  OPT_s = 1166,                              /* -s */
  OPT_s_bc_abi = 1167,                       /* -s-bc-abi */
  OPT_save_temps = 1168,                     /* -save-temps */
  OPT_save_temps_ = 1169,                    /* -save-temps= */
  OPT_shared = 1170,                         /* -shared */
  OPT_shared_libgcc = 1171,                  /* -shared-libgcc */
  /* OPT_specs = 1172, */                    /* -specs */
  OPT_specs_ = 1173,                         /* -specs= */
  OPT_static = 1174,                         /* -static */
  OPT_static_libasan = 1175,                 /* -static-libasan */
  OPT_static_libgcc = 1176,                  /* -static-libgcc */
  OPT_static_libgcj = 1177,                  /* -static-libgcj */
  OPT_static_libgfortran = 1178,             /* -static-libgfortran */
  OPT_static_libgo = 1179,                   /* -static-libgo */
  OPT_static_liblsan = 1180,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1181,               /* -static-libstdc++ */
  OPT_static_libtsan = 1182,                 /* -static-libtsan */
  OPT_static_libubsan = 1183,                /* -static-libubsan */
  /* OPT_std_c__03 = 1184, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1185, */                /* -std=c++0x */
  OPT_std_c__11 = 1186,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1187, */                /* -std=c++14 */
  OPT_std_c__1y = 1188,                      /* -std=c++1y */
  OPT_std_c__98 = 1189,                      /* -std=c++98 */
  OPT_std_c11 = 1190,                        /* -std=c11 */
  /* OPT_std_c1x = 1191, */                  /* -std=c1x */
  /* OPT_std_c89 = 1192, */                  /* -std=c89 */
  OPT_std_c90 = 1193,                        /* -std=c90 */
  OPT_std_c99 = 1194,                        /* -std=c99 */
  /* OPT_std_c9x = 1195, */                  /* -std=c9x */
  OPT_std_f2003 = 1196,                      /* -std=f2003 */
  OPT_std_f2008 = 1197,                      /* -std=f2008 */
  OPT_std_f2008ts = 1198,                    /* -std=f2008ts */
  OPT_std_f95 = 1199,                        /* -std=f95 */
  OPT_std_gnu = 1200,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1201, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1202, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1203,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1204, */              /* -std=gnu++14 */
