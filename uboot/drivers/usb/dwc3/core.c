...
#ifdef CONFIG_USB_RTK_DWC3_GADGET
extern void rtk_dwc3_usb3_phy_setting(struct dwc3 *dwc);
extern void rtk_dwc3_usb2_phy_setting(struct dwc3 *dwc);
extern int rtk_dwc3_get_phy_data(struct dwc3 *dwc);
#endif
...
#ifdef CONFIG_USB_RTK_DWC3_GADGET
	dwc->regs	= (int *)(dwc3_dev->base + 0x8100);
#else
